========================================================================
    KONSOLENANWENDUNG: FShell w32-Projektübersicht
========================================================================

Diese FShell w32-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre FShell w32-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen FShell w32.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
